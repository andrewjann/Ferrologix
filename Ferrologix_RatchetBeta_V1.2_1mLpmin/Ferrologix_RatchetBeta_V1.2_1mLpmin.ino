...
const long on_interval = 20000; //On duty cycle for pumping (.02 sec)
const long off_interval = 480000;//On duty cycle for pumping (.048 sec) 
//Flow Rate=27mL per min * on_interval/(on_interval+off_interval)
//Current Flow Rate=0.52mL/min
int j = 1;
